...
class __Mustache_936ab09456ada60ea172d876755e93d5 extends Mustache_Template
{
...
';
        ...
        $buffer .= ' style="margin: 0 !important; padding: 0 !important; overflow-x: hidden;">
';
        $buffer .= $indent . '<link rel="stylesheet" href="/local/istikama_admin/styles/landing.css?v=1">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '<!-- ABSOLUTELY NO WRAPPERS. 100% UNRESTRICTED -->
';
