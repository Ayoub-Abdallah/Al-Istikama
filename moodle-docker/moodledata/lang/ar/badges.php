...
/**
 * Strings for component 'badges', language 'ar', version '5.1'.
 *
 * @package     badges
 * @category    string
...
$string['badgeimageinfo'] = 'لأفضل النتائج، إرفع صورةمربعة ذات أبعاد لا تقل عن 300 × 300 بكسل.';
...
$string['contact'] = 'البريد الالكتروني';
...
$string['descriptioninfo'] = 'ماذا تمثل هذه الشارة؟';
...
$string['fixed'] = 'تاريخ ثابت: هذه الشارة تنتهي صلاحيتها في التاريخ الآتي:';
$string['hidden'] = 'مخفي';
...
$string['never'] = 'أبداً: هذه الشارة لا تنتهي صلاحيتها.';
...
$string['relative'] = 'التاريخ النسبي: هذه الشارة تنتهي صلاحيتها بعد فترة من الزمن:';
