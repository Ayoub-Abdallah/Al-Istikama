...
/**
 * Strings for component 'feedback', language 'ar', version '5.1'.
 *
 * @package     feedback
 * @category    string
...
$string['append_new_items'] = 'الإبقاء على الأسئلة الموجودة وإضافة الأسئلة الجديدة بعد نهايتها';
$string['autonumbering'] = 'استعمل الترقيم التلقائي للأسئلة';
$string['autonumbering_help'] = 'تمكين أو تعطيل الترقيم التلقائي لكل سؤال';
$string['availableforallcourses'] = 'متاح لكل المساقات';
...
$string['feedbackclose'] = 'السماح بالإجابات حتى';
...
$string['previewtemplate'] = 'استعراض مظهر \'{$a}\'';
...
$string['save_as_new_template'] = 'الحفظ كمظهر جديد';
...
$string['sitetemplates'] = 'مظاهر الموقع';
...
$string['this_feedback_is_already_submitted'] = 'لقد قمت مسبقاً بتقديم هذ الإفادة.';
...
$string['whatfor'] = 'كيف تريد تطبيق القالب؟';
