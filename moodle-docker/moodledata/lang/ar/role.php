...
/**
 * Strings for component 'role', language 'ar', version '5.1'.
 *
 * @package     role
 * @category    string
...
$string['ai:viewaipolicyacceptancereport'] = 'معاينة تقرير قبول سياسة الذكاء الاصطناعي';
$string['ai:viewaiusagereport'] = 'معاينة تقرير استعمال الذكاء الاصطناعي';
$string['allow'] = 'سماح';
...
$string['course:changelockedcustomfields'] = 'تغيير الحقول المخصصة المؤمنة';
...
$string['course:viewoverview'] = 'معاينة صفحة استعراض النشاطات';
...
$string['customfield:configureshared'] = 'تهيئة الحقول المخصصة المشارك بها';
...
$string['reportbuilder:configurecustomfields'] = 'تهيئة حقول التقرير المخصص';
