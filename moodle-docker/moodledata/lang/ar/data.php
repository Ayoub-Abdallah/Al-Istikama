...
/**
 * Strings for component 'data', language 'ar', version '5.1'.
 *
 * @package     data
 * @category    string
...
$string['number'] = 'رقم';
$string['numberofentriestoapprove'] = 'المُدخلات بانتظار الموافقة عليها: {$a}';
...
$string['totalentries'] = 'إجمالي المُدخلات';
...
$string['viewentries'] = 'معاينة المُدخلات';
