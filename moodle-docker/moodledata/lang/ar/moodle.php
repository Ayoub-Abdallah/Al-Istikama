...
/**
 * Strings for component 'moodle', language 'ar', version '5.1'.
 *
 * @package     moodle
 * @category    string
...
$string['count_of_total'] = '<strong>{$a->count}</strong> من {$a->total}';
...
$string['datetimefilterafter'] = 'بعد {$a->title}';
$string['datetimefilterbefore'] = 'قبل {$a->title}';
$string['day'] = 'يوم';
$string['days'] = 'أيام';
...
$string['eventcourseoverviewviewed'] = 'صفحة استعراض نشاطات المساق تمت معاينتها';
...
$string['gpl'] = 'الحقوق الفكرية (C) 1999 ولاحقاً Ayoub Ben Chahla (https://moodle.com)
...
$string['gpl3'] = 'الحقوق الفكرية (C) 1999 ولاحقاً Ayoub Ben Chahla (https://moodle.com)
...
$string['hiddensectionscollapsed'] = 'إظهار أسماء المقاطع فقط';
$string['hiddensectionscollapsed_description'] = 'يتم إظهار أسماء المقاطع للطلاب، ولكن محتوياتها مخفية.';
$string['hiddensectionsinvisible'] = 'الإخفاء تماماً';
$string['hiddensectionsinvisible_description'] = 'لا يتم عرض المقاطع المخفية للطلاب.';
$string['hiddenwithbrackets'] = '(مخفي)';
$string['hide'] = 'إخفاء';
$string['hideadvancedsettings'] = 'إخفاء الإعدادات المتقدمة';
$string['hidecategory'] = 'أتريد إخفاء التصنيف؟';
$string['hidecategorymany'] = 'التصنيف {$a->category} يحتوي على {$a->coursecount} من المساقات.
<br/>إذا أخفيته، لن يكون بإمكان المستخدمين الذين ليست لديهم صلاحية معاينة التصنيفات المخفية، إمكانية الوصول إلى تلك المساقات.';
$string['hidecategoryone'] = 'التصنيف {$a->category} يحتوي على مساق واحد.
<br/>إذا أخفيته، لن يكون بإمكان المستخدمين الذين ليست لديهم صلاحية معاينة التصنيفات المخفية، إمكانية الوصول إلى ذلك المساق.';
...
$string['maxnumberweeks'] = 'أقصى عدد من المقاطع (مهمل)';
$string['maxnumberweeks_desc'] = 'الحد الأقصى للقيمة في القائمة المنسدلة لعدد الأقسام (ينطبق على تنسيقات مادة محددة فقط).
هذا الإعداد مهمل وستتم إزالته من الإصدار القادم من مودل. يرجى استعمال إعدادات تنسيق المساق بدلاً منه.';
...
$string['modhidden'] = 'الإتاحة';
$string['modhidden_help'] = '* الإخفاء في صفحة المساق: غير متاح للطلاب. لا يمكن إظهار هذه الوحدة للطلاب.';
...
$string['moveitemdown'] = 'أنقل {$a} إلى الأسفل';
$string['moveitemup'] = 'أنقل {$a} إلى الأعلى';
...
$string['noresultsfor_help'] = 'تحقق من إملائك أو حاول مع كلمات أخرى.';
$string['normal'] = 'عادي';
...
$string['paymentrequired'] = 'هذا المساق يتطلب دفع تكلفة لدخوله';
...
$string['privacy:metadata:shortlink'] = 'تفاصيل الرابط المختصر';
$string['privacy:metadata:shortlink:component'] = 'المكون المتعلق بالرابط المختصر';
$string['privacy:metadata:shortlink:identifier'] = 'المُعرف الفريد المتعلق بالرابط المختصر';
$string['privacy:metadata:shortlink:linktype'] = 'نوع الرابط الذي يُعرف به الرابط المختصر';
$string['privacy:metadata:shortlink:shortcode'] = 'الترميز المختصر المستعمل للرابط المختصر';
$string['privacy:metadata:shortlink:userid'] = 'مُعرف المستخدم المتعلق بالرابط المختصر';
...
$string['resource_type'] = 'نوع المورد';
...
$string['selectdates'] = 'إختر الأيام';
...
$string['showpopovermenu'] = 'إفتح النافذة المنبثقة';
