...
/**
 * Strings for component 'offlinequiz', language 'ar', version '5.1'.
 *
 * @package     offlinequiz
 * @category    string
...
$string['couldnotextractpages'] = 'وقع خطأ عند استخراج الصفحات من الملفات المرفوعة.';
$string['couldnotextractpdf'] = 'وقع خطأ عند تحويل ملف PDF إلى صفحات منفردة. يرجى المحاولة مع مستند أصغر أو تواصل مع مشرفك.';
$string['couldnotextracttiff'] = 'وقع خطأ عند تحويل ملف TIFF إلى صفحات منفردة. يرجى المحاولة مع مستند أصغر أو تواصل مع مشرفك.';
$string['couldnotgrab'] = 'تعذر انتزاع الصورة {$a}';
$string['couldnotinsertjobs'] = 'وقع خطأ مع قاعدة البيانات خلال استخراج الصفحات';
$string['couldnotregister'] = 'تعذر تسجيل المستخدم {$a}';
$string['createcategoryandaddrandomquestion'] = 'أنشئ صنفاً وأضف سؤالاً عشوائياً';
$string['createlistfirst'] = 'أضف قوائم المشاركين أولاً';
...
$string['furtheroptionsheading'] = 'مزيد من الخيارات';
...
$string['messageprovider:jobs'] = 'إشعارات الاختبار غير المتصل';
...
يُحتفظ بهذه الأسئلة في بنك أسئلة مودل ويمكن استعمالها مجددًا ضمن المساقات، لا بل حتى فيما بينها.
...
<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-einstellungen/?lng=en" target="_blank">الاختبار غير المتصل: الإعدادات</a></p>
<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-fragen-hinzufugen-und-formulare-generieren/?lng=en" target="_blank">الاختبار غير المتصل: إضافة الأسئلة وتوليد النماذج</a></p>
<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-durchfuhren-und-auswerten/?lng=en" target="_blank">الاختبار غير المتصل: تنفيذ الاختبار غير المتصل وتقييمه</a></p>';
...
$string['privacy:metadata:offlinequizpagesize'] = 'يحدد عدد مُدخلات صفحة النتائج';
...
$string['queueamountofpages'] = 'عدد الملفات المضمنة:';
$string['queuedownload'] = 'تنزيل';
$string['queuefilecorrect'] = 'تصويب';
$string['queuefilecorrectionhovertext'] = 'التصويب';
$string['queuefiledownloadhovertext'] = 'تنزيل';
$string['queuefileerror'] = 'رسالة الخطأ:';
$string['queuefilefilename'] = 'الملف المصدر:';
$string['queuefilegroupnumber'] = 'رقم المجموعة:';
$string['queuefileheader'] = 'الصفحات في هذا الملف';
$string['queuefileimportedat'] = 'الملف تم استيراده:';
$string['queuefileimportedby'] = 'مستورد من قبل:';
$string['queuefilenotstarted'] = 'التقييم لم يبدأ بعد';
$string['queuefilepagenumber'] = 'رقم الصفحة:';
$string['queuefileprocessing'] = 'التقييم قيد التقدم...';
$string['queuefilesactionsheader'] = 'الإجراءات';
$string['queuefilesdetailsheader'] = 'التفاصيل';
$string['queuefilesfileheader'] = 'الملف';
$string['queuefilestatus'] = 'حالة الملف:';
$string['queuefilestatusheader'] = 'الحالة';
$string['queuefilestatusmessage_error'] = 'التصويب ضروري';
$string['queuefilestatusmessage_new'] = 'مُسلَّمة';
$string['queuefilestatusmessage_processed'] = 'تمام';
$string['queuefilestatusmessage_processing'] = 'تجري المعالجة';
$string['queuefilestatusmessage_submitted'] = 'مُسلَّمة';
$string['queuefilestudent'] = 'اسم الطالب:';
$string['queuefinishedtime'] = 'التقييم انتهى في:';
$string['queueheader'] = 'الملفات المرفوعة';
$string['queuenotfinished'] = 'التقييم لم ينته بعد';
$string['queuenotstarted'] = 'التقييم لم يبدء بعد';
$string['queuestarttime'] = 'التقييم بدء في:';
$string['queuestatus'] = 'حالة الطابور';
...
$string['resetofflinequizzes'] = 'إعادة تعيين بيانات الاختبار غير المتصل';
...
$string['selectquestion'] = 'إختر السؤال {$a}';
...
$string['tutorial:feedback:3:1'] = 'يحدث المسح الضوئي فقط للخطوط التي في خانات التأشير. لهذا السبب من المهم تأشير الخانات الصحيحة التي تحت رقمك التعريفي.';
$string['tutorial:feedback:3:2'] = 'يحدث المسح الضوئي فقط للخطوط التي في خانات التأشير. لهذا السبب من المهم تأشير الخانات الصحيحة التي تحت رقمك التعريفي.';
$string['tutorial:feedback:3:3'] = 'يحدث المسح الضوئي فقط للخطوط التي في خانات التأشير. لهذا السبب من المهم تأشير الخانات الصحيحة التي تحت رقمك التعريفي.';
$string['tutorial:feedback:3:4'] = 'يحدث المسح الضوئي فقط للخطوط التي في خانات التأشير. لهذا السبب من المهم تأشير الخانات الصحيحة التي تحت رقمك التعريفي.';
$string['tutorial:feedback:4:0'] = 'لقد أخطأت. إن رقمك التعريفي هو {$a->correctusernumber}، ولكن ما أشرته هو {$a->selectedusernumber}';
...
$string['tutorial:generatedusernumberwarning'] = 'هذا رقم تعريفي عام نظرًا لكون حسابك لا يمتلك رقمًا تعريفيًا!';
...
$string['tutorial:header:4'] = '4. تأشير رقمك التعريفي';
$string['tutorial:header:5'] = '5. أخيرًا';
$string['tutorial:identification_info'] = 'رقمك التعريفي هو: {$a}';
...
$string['tutorial:introduction:3:1'] = 'يحتوي نموذج الإجابة على خانة لاسمك (أ)، وخانة لرقم هويتك (ب)، وخانة للإجابات (ج). املأ الخانات المخصصة لاسمك وتوقيعك ورقم هويتك أولًا. يُرجى العلم أن الجهاز لن يحاول قراءة خط يدك بعد الامتحان. هذه الخانات مخصصة لأغراض التوثيق فقط.';
$string['tutorial:introduction:3:2'] = 'حدّد خانات رقم تعريفك بعناية، إذ سيحتاجها الحاسوب لتحديد نتائجك. قد تؤدي الأخطاء في خانة رقم تعريفك إلى تأخير وسوء فهم.';
$string['tutorial:introduction:4'] = 'في نهاية هذا الدرس التعليمي، نقدم لكم اختبارًا صغيرًا لتعلم كيفية ملء خانات رقم هويتك بشكل صحيح. أسفل خانة رقم هويتك، توجد مصفوفة من خانات التأشير. يمثل كل عمود رقمًا واحدًا من رقم هويتك. تشير الصفوف إلى الأرقام المكتوبة على الجانبين الأيمن والأيسر. انقر على الخانات لتحديدها. انقر مرة أخرى لحذف علامتك. إذا أردت البدء من جديد، يُرجى <a href="javascript: document.location.reload()">إعادة تحميل الصفحة</a>.';
...
$string['tutorial:option:3:3'] = 'فقط التأشيرات بعلامات × في خانات التأشير هي التي يتم تفسيرها.';
$string['tutorial:option:3:4'] = 'يقرأ النظام رقمك التعريفي باستعمال برنامج ضوئي لتمييز الحروف.';
...
$string['tutorial:question:4'] = 'الرقم التعريفي';
...
$string['tutorial:start_text'] = 'يُفترض أن يُرشدك هذا الدرس التعليمي إلى الطريقة الصحيحة لملء نماذج الاختبار غير المتصل وتأشير إجاباتك للتقييم التلقائي. ننصحك بشدة بتنفيذ هذا الدرس التعليمي مرة واحدة على الأقل قبل خوض أول اختبار أو امتحان لك باستعمال الاختبار غير المتصل.';
$string['tutorial:starttutorial'] = 'بدء الدرس التعليمي';
...
$string['unknownmimetype'] = 'نوع mimetype مجهول أو غير مدعوم {$a->mimetpye}';
...
$string['upgradingilogs'] = 'إعادة تعيين بيانات الاختبار غير المتصل';
$string['upgradingofflinequizattempts'] = 'ترقية محاولات الاختبار غير المتصل: الاختبار غير المتصل {$a->done}/{$a->outof} <br/>(مُعرَّف الاختبار غير المتصل {$a->info})';
$string['upload'] = 'رفع';
$string['uploadfurtherfiles'] = 'رفع المزيد من الملفات';
...
$string['usetabs'] = 'استعمل التنقل على أساس التبويبات';
$string['usetabsdesc'] = 'عند تمكينه، سيتم عرض تنقلات المستوى الثالث للاختبار غير المتصل بشكل تبويبات. عند تعطيله، سيتم عرض التنقل للاختبار غير المتصل باستعمال قائمة منسدلة.';
$string['valuezero'] = 'القيمة ينبغي أن لا تكون صفرًا';
$string['viewresults'] = 'معاينة النتائج';
$string['white'] = 'أبيض';
$string['wirismathenabled'] = 'تمكين معادلات الرياضيات من WIRIS';
$string['wirismathenabled_help'] = 'عند تمكينه، يمكن استعمال معادلات الرياضيات من WIRIS في نص السؤال وإجاباته.';
