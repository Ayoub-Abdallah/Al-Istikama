...
/**
 * Strings for component 'filter_mathjaxloader', language 'ar', version '5.1'.
 *
...
$string['mathjaxsettings_desc'] = 'إن التهيئة الافتراضية لـ MathJax ينبغي أن تكون مناسبة لأغلب المستخدمين، ولكن MathJax قابل للتخصيص إلى حد كبير ويمكن هنا إضافة أي من خيارات التهيئة القياسية لـ MathJax بصيغة JSON. ينبغي أن يكون هذا الحقل فارغًا أو محتويًا على مكون JSON صالح! على سبيل المثال، لتمكين AsciiMath وميزة zoom، إضبط هذا الحقل إلى قيمة:
<pre>
{
