...
/**
 * Strings for component 'quizaccess_quilgo', language 'ar', version '5.1'.
 *
...
$string['proctoring_disabled_info'] = 'المراقبة الآلية <i>معطلة</i>. للتمكين، إنتقل إلى <a href="{$a}"><u>إعدادات الاختبار</u></a>، وقم بتوسيع "القيود الإضافية على المحاولات"، وقم بتأشير خانة "تمكين المراقبة"، واختر طريقة التتبع، أنقر على "حفظ"، ثم عد إلى هذه الصفحة.';
...
$string['report_expired'] = 'تم حذف الصور من التقرير من النظام بسبب انتهاء صلاحيتها';
