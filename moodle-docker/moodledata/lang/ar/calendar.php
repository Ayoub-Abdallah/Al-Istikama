...
/**
 * Strings for component 'calendar', language 'ar', version '5.1'.
 *
 * @package     calendar
 * @category    string
...
$string['timerelativetoday'] = 'اليوم، {$a}';
$string['timerelativetomorrow'] = 'غدًا، {$a}';
$string['timerelativeyesterday'] = 'أمس، {$a}';
$string['today'] = 'اليوم';
