...
/**
 * Strings for component 'enrol_database', language 'ar', version '5.1'.
 *
...
$string['dbsybasequoting_desc'] = 'نمط الاستبدال بعلامة اقتباس مفردة لـ Sybase. مطلوب لـ MS SQL وبعض أنظمة قواعد البيانات الأخرى. لا تستعمله مع MySQL!';
