...
/**
 * Strings for component 'cachestore_file', language 'ar', version '5.1'.
 *
...
$string['useserializer'] = 'مسلسِل المستخدمين';
$string['useserializer_help'] = 'المسلسِل المستعمل لتوليد الرقم التسلسلي. عند تواجده، يمكن لمسلسِل igbinary تقليل متطلبات الخزن المترتبة على الخبء الكبير الحجم، وهذا مدعوم فقط عند تحميل الامتداد igbinary.';
