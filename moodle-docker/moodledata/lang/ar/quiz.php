...
/**
 * Strings for component 'quiz', language 'ar', version '5.1'.
 *
 * @package     quiz
 * @category    string
...
$string['allowedattemptsperstudent'] = 'المحاولات المسموح بها لكل طالب';
...
$string['averageattemptsperstudent'] = 'متوسط المحاولات لكل طالب';
...
$string['overridesnoneforgroups'] = 'ليست هناك تجاوزات للمجموعة في هذا الاختبار.';
$string['overridesnoneforusers'] = 'ليست هناك تجاوزات للمستخدمين في هذا الاختبار.';
...
$string['precreateattempts_desc'] = 'الإنشاء المسبق للمحاولات يساعد في تحسين أداء الموقع. فضلاً عن تمكين هذا الإعداد، تحتاج إلى ضبط فترة الإنشاء المسبق. ملاحظة: هذا الإعداد يطبق فقط مع الاختبارات التي فيها موعد فتح.';
...
$string['precreateperiod'] = 'فترة الإنشاء المسبق للمحاولات';
$string['precreateperiod_desc'] = 'إذا كان موقعك يحتوي على اختبارات قصيرة بوقت فتح محدد، ويبدأ العديد من الطلاب في نفس الوقت، يمكنك تحسين الأداء من خلال إنشاء المحاولات مسبقًا. حدد فترة زمنية قبل فتح الاختبار لإنشاء المحاولات مسبقًا. يُنصح بفترة زمنية أقصر، إذ لا يمكن تعديل أسئلة الاختبار بعد بدء المحاولات. يتم إنشاء المحاولات من خلال مهمة مجدولة تعمل كل ساعة افتراضيًا. لإنشاء المحاولات مسبقًا عندما يكون النظام هادئًا، مثلاً أثناء الليل، اضبط الفترة على ١٢ ساعة، ثم اضبط المهمة المجدولة لتعمل خلال ساعات الهدوء.';
...
$string['stateoptions_help'] = '* لم تبدأ: تم إنشاء المحاولة تلقائيًا قبل فتح الاختبار. الطالب لم يبدأ المحاولة بعد.
* جارية: الطالب بدأ بالمحاولة. لا يزال لديه متسع من الوقت لتسليمها.
* متأخرة: المحاولة مفتوحة لوقت أكثر مما هو مسموح لها. لا يزال بإمكان الطالب تسليمها ضمن فترة السماح.
...
$string['studentswhoattempted'] = 'الطلاب الذين حاولوا';
...
$string['top'] = 'أعلى';
$string['totalattempts'] = 'إجمالي المحاولات';
...
$string['usersnone'] = 'لا يوجد طلاب منضمون إلى هذا المساق أو لا طلاب يمكنهم الوصول إلى الاختبار.';
