...
$string['rootdirpublic'] = 'بنبغي أن لايكون مجلد الجذر لتنصيب مودل متاح للعامة. يرجى إعادة ضبط مخدمك لاستعمال المجلد `/public` بدلاً منه.';
...
$string['wwwrootpublic'] = 'هناك خطأ في واصفة $CFG->wwwroot في الملف config.php، ينبغي أن لا ينتهي بـ /public.';
