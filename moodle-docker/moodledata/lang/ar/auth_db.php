...
/**
 * Strings for component 'auth_db', language 'ar', version '5.1'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbsybasequotinghelp'] = 'نمط Sybase لاستعادة علامة الاقتباس المفردة في النص المرمز. مطلوب من أجل MS SQL وبعض قواعد البيانات الأخرى. لا تستعملها مع MySQL!';
