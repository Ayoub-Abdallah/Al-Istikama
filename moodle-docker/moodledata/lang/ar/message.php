...
/**
 * Strings for component 'message', language 'ar', version '5.1'.
 *
 * @package     message
 * @category    string
...
$string['cannotsendmessages'] = 'لا يمكن إرسال الرسائل';
...
$string['conversation'] = 'المحادثة';
$string['conversationactions'] = 'قائمة إجراءات المحادثة';
$string['conversationtype'] = 'النوع';
$string['decline'] = 'أرفض';
...
$string['nopermissiontosend'] = 'ليست لديك صلاحية إرسال الرسائل في هذه المحادثة';
...
$string['sendbulkmessagesentwitherrors'] = 'تم إرسال الرسالة {$a->sent} من {$a->total} من الأشخاص';
...
$string['successproviderenabled'] = '\'{$a->provider}\' لـ \'{$a->processor}\' تم تحديثه.';
$string['successproviderlocked'] = '\'{$a->provider}\' لـ \'{$a->processor}\' تم تأمينه.';
$string['successproviderunlocked'] = '\'{$a->provider}\' لـ \'{$a->processor}\' تم إلغاء تأمينه.';
$string['successproviderupdate'] = '\'{$a}\' تم تحديثه.';
...
$string['unsentmessagenotification'] = 'لديك رسالة غير مُرسلة. ستفقدها إذا غادرت هذه الصفحة.';
$string['useentertosend'] = 'استعمل مفتاح الرجوع للإرسال';
$string['usercantbemessaged'] = 'لا يمكنك مراسلة {$a} بسبب تفضيلات المراسلة لديه. حاول إضافته إلى جهات اتصالك.';
$string['usercantbemessagedbulk'] = 'لا يمكنك مراسلة المستخدمين الآتين بسبب تفضيلات المراسلة لديهم. حاول إضافتهم إلى جهات اتصالك.<br>{$a}';
