...
/**
 * Strings for component 'bigbluebuttonbn', language 'ar', version '5.1'.
 *
...
$string['resetrecordings_help'] = 'سيؤدي حذف التسجيلات إلى إزالتها من هذا المساق. الوسائط المخزنة في مخدم BigBlueButton لن تتأثر.';
...
$string['view_recording_delete_confirmation'] = 'هل أنت متأكد من رغبتك في حذف {$a} بشكل نهائي؟ هذا من شأنه حذف ملف الوسائط من مخدم BigBlueButton ولا يمكن التراجع عن ذلك.';
