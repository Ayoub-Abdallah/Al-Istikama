...
/**
 * Strings for component 'course', language 'ar', version '5.1'.
 *
 * @package     course
 * @category    string
...
$string['activitylink'] = 'الرابط الدائم';
...
$string['addselectedactivity'] = 'إضافة النشاط المحدد';
...
$string['aria:modulefavourite'] = 'إضافة {$a} إلى المُعلمة بنجمة';
$string['aria:moduleunfavourite'] = 'إزالة {$a} من المُعلمة بنجمة';
...
$string['courseurl'] = 'عنوان رابط المساق';
$string['customfield_islocked'] = 'مؤَّمن';
$string['customfield_islocked_help'] = 'إذا تم تأمين الحقل، فوحدهم المستخدمون الذين لديهم إمكانية تغيير الحقول المخصصة المؤمنة (المستخدمون ذوو الدور الافتراضي للمدير فقط) من تغييره في إعدادات المساق.';
...
$string['mod_purpose_administration'] = 'الإدارة';
$string['mod_purpose_administration_help'] = 'أدوات إدارة المساق.';
$string['mod_purpose_assessment'] = 'التقييم';
$string['mod_purpose_assessment_help'] = 'النشاطات التي تدعم التقييم وقياس مدى فهم الطلبة وأدائهم، بما في ذلك التقييمات الفردية والجماعية، والتقييمات المناظرة.';
$string['mod_purpose_collaboration'] = 'التعاون';
$string['mod_purpose_collaboration_help'] = 'أدوات التعلم التعاوني التي تشجع تبادل المعارف، المناقشات والعمل الفرقي.';
$string['mod_purpose_communication'] = 'الاتصالات';
$string['mod_purpose_communication_help'] = 'النشاطات المخصصة للتواصل في الوقت الحقيقي، التعاملات غير المتزامنة وجمع الإفادات.';
$string['mod_purpose_content'] = 'الموارد';
$string['mod_purpose_content_help'] = 'النشاطات والأدوات المعدة لتنظيم وعرض مواد المساق مثل المستندات، روابط الويب والوسائط المتعددة.';
$string['mod_purpose_interactivecontent'] = 'المحتوى التفاعلي';
$string['mod_purpose_interactivecontent_help'] = 'النشاطات التفاعلية المشوقة التي تشجع المشاركة الفاعلة للمتعلم.';
$string['mod_purposes'] = 'التصنيفات';
...
$string['overview_info'] = 'معاينة كل النشاطات في المساق، مع التواريخ وغيرها من المعلومات.';
$string['overview_missing_notice'] = 'إذهب إلى {$a}.';
$string['overview_missing_title'] = 'لا تتوفر معلومات عن {$a}.';
$string['overview_modname'] = 'النظرة العامة لـ {$a}';
$string['overview_nogroups_error'] = 'أنت غير منضم إلى أي مجموعة';
$string['overview_nogroups_title'] = 'المعلومات غير متاحة لأنك غير منضم إلى أي مجموعة';
$string['overview_page_title'] = 'نشاطات المساق: {$a}';
$string['overview_table_caption'] = 'الجدول يُدرج كل النشاطات البالغ عددها {$a}';
...
$string['recommended_help'] = 'النشاطات الموصى بها من قبل منظمتك.';
...
$string['supports'] = 'هذا النشاط يدعم';
