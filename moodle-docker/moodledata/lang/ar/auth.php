...
/**
 * Strings for component 'auth', language 'ar', version '5.1'.
 *
 * @package     auth
 * @category    string
...
$string['auth_forgotpasswordrecaptcha'] = 'تمكين reCAPTCHA لصفحة نسيان كلمة المرور';
$string['auth_forgotpasswordrecaptcha_desc'] = 'أضف عنصر نموذج تأكيد مرئي/مسموع إلى صفحة نسيت كلمة المرور. هذا يقلل من مخاطر المحاولات غير المبررة لاستعمال تلك الصفحة. لمزيد من التفاصيل أنظر <a href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
