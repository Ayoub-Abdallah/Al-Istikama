...
/**
 * Strings for component 'qtype_calculated', language 'ar', version '5.1'.
 *
...
$string['forceregenerationall'] = 'فرض إعادة توليد كل البطاقات البديلة';
...
$string['reuseifpossible'] = 'إعادة استعمال القيمة السابقة إن كانت متاحة';
