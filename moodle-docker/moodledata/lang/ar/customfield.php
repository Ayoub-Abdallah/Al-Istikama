...
/**
 * Strings for component 'customfield', language 'ar', version '5.1'.
 *
 * @package     customfield
 * @category    string
...
$string['eventsharedcategoryusagedisabled'] = 'استعمال التصنيف المشترك تم تعطيله';
$string['eventsharedcategoryusageenabled'] = 'استعمال التصنيف المشترك تم تمكينه';
...
$string['privacy:metadata:customfield_shared'] = 'يمثل مشاركة الحقل المخصص المحفوظ في سياق ما';
$string['privacy:metadata:customfield_shared:area'] = 'المنطقة التي يرتبط بها الحقل المشارك';
$string['privacy:metadata:customfield_shared:categoryid'] = 'مُعرَّف التصنيف الذي يعود إليه الحقل المشارك';
$string['privacy:metadata:customfield_shared:component'] = 'المكون الذي يرتبط به الحقل المشارك';
$string['privacy:metadata:customfield_shared:itemid'] = 'مُعرَّف العنصر الذي يرتبط به الحقل المشارك';
...
$string['sharedcategoryhelptext'] = 'عند تمكينه، سيتم استعمال الحقول المخصصة في هذا التصنيف';
$string['sharedcustomfields'] = 'الحقول المخصصة المشارك بها';
