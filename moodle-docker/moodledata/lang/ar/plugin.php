...
/**
 * Strings for component 'plugin', language 'ar', version '5.1'.
 *
 * @package     plugin
 * @category    string
...
$string['deprecated_type'] = 'نوع ملحق متروك';
...
$string['type_core'] = 'نظام فرعي أساسي';
$string['type_core_plural'] = 'أنظمة فرعية أساسية';
...
$string['type_gradepenalty'] = 'غرامة الدرجة';
$string['type_gradepenalty_plural'] = 'غرامات الدرجات';
