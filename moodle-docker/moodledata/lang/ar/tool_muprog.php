...
/**
 * Strings for component 'tool_muprog', language 'ar', version '5.1'.
 *
 * @package     tool_muprog
 * @category    string
...
$string['management_program_users_actions'] = 'تفاعلات المستخدم';
...
$string['publicaccess_help'] = 'المستويات العامة تظهر لكل المستخدمين.

حالة ظهور المستوى لا تُؤثر بظهوره لدى الطلاب المنضمين للمستوى بالفعل';
...
$string['source_approval_notification_approval_request_body'] = 'المستخدم {$a->user_fullname} قدّم طلب للتسجيل على "{$a->program_fullname}".';
...
$string['source_program'] = 'مستوى منتهٍ';
$string['source_program_allownew'] = 'السماح بإضافة الطلاب بناءً على نجاحهم في مستوى سابق';
$string['source_program_allownew_desc'] = 'السماح بإضافة مصادر إكمال مستويات إضافية إلى المستويات';
$string['source_program_completedprogram'] = 'مستوى للإكمال';
...
$string['tagarea_tool_muprog_program'] = 'المستويات';
