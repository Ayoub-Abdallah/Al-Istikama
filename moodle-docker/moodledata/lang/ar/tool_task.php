...
/**
 * Strings for component 'tool_task', language 'ar', version '5.1'.
 *
 * @package     tool_task
 * @category    string
...
$string['confirmdeletetaskwithid'] = 'هل أنت متأكد من رغبتك في حذف المهمة ذات المُعرَّف: {$a->id}؟';
...
$string['deleteadhoctask'] = 'حذف المهمة المخصصة {$a}';
...
$string['runclassnamedueonly'] = 'تشغيل المستوجبة فقط';
