...
/**
 * Strings for component 'search_solr', language 'ar', version '5.1'.
 *
 * @package     search_solr
 * @category    string
...
$string['check_indextoobig'] = 'الفهرس أكبر من الحجم المحدد';
$string['check_nocore'] = 'يتعذر العثور على الفهرس في مخدم Solr';
$string['check_nosize'] = 'يتعذر تحديد حجم الفهرس في مخدم Solr';
$string['check_notconnected'] = 'يتعذر الاتصال مع مخدم Solr';
$string['check_time'] = 'استجاب المخدم مع الحالة {$a}';
...
$string['indexsize'] = 'الفهرس يستعمل {$a} في مخدم Solr.';
$string['indexsizelimit'] = 'محدد حجم الفهرس';
$string['indexsizelimit_desc'] = 'يظهر خطأ في صفحة تقرير الحالة إذا تخطى حجم فهرس البحث هذا المقدار (بالبايت)، وتحذير إذا تخطى 90%. إضبطه على 0 لتخطي مراقبة حد حجم الفهرس.';
