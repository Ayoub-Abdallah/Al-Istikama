...
/**
 * Strings for component 'question', language 'fr', version '5.1'.
 *
 * @package     question
 * @category    string
...
$string['invalidcategory'] = 'Catégorie non valide fournie pour voir cette banque de questions.';
$string['invalidcategoryeditq'] = 'Catégorie non valide fournie pour voir cette banque de questions. Demander à l’administrateur de lancer le script question/cli/fix_set_references_category_context.php';
...
$string['nobankpermissions'] = 'Vous n’avez pas les permissions requises pour accéder à une banque de questions de ce cours.';
