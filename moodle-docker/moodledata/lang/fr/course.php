...
/**
 * Strings for component 'course', language 'fr', version '5.1'.
 *
 * @package     course
 * @category    string
...
$string['addselectedactivity'] = 'Ajouter l’activité sélectionnée';
...
$string['aria:modulefavourite'] = 'Ajouter {$a} aux favoris';
$string['aria:moduleunfavourite'] = 'Retirer {$a} des favoris';
...
$string['mod_purpose_administration_help'] = 'Outils de gestion de cours.';
$string['mod_purpose_assessment'] = 'Évaluation';
$string['mod_purpose_assessment_help'] = 'Outils qui prennent en charge l\'évaluation, la mesure de la compréhension et de la performance des étudiants, y compris l\'évaluation individuelle et collaborative et l\'évaluation par les pairs.';
$string['mod_purpose_collaboration'] = 'Collaboration';
$string['mod_purpose_collaboration_help'] = 'Activités d’apprentissage collaboratif, qui encouragent le partage de connaissances, la discussion et le travail d\'équipe des étudiants.';
$string['mod_purpose_communication'] = 'Communication';
$string['mod_purpose_communication_help'] = 'Activités de communication en temps réel, les interactions asynchrones et la collecte de feedback.';
$string['mod_purpose_content'] = 'Ressources';
$string['mod_purpose_content_help'] = 'Activités et outils pour organiser et afficher les contenus de cours, tels que documents, liens web et multimédia.';
$string['mod_purpose_interactivecontent'] = 'Contenu interactif';
$string['mod_purpose_interactivecontent_help'] = 'Activités interactives stimulantes qui encouragent la participation active des étudiants.';
$string['mod_purposes'] = 'Catégories';
...
$string['overview_nogroups_error'] = 'Vous n’êtes membre d’aucun groupe';
$string['overview_nogroups_title'] = 'Informations non disponibles, car vous n’êtes membre d’aucun groupe';
...
$string['recommended_help'] = 'Activités recommandées par votre institution.';
...
$string['supports'] = 'Cette activité prend en charge';
