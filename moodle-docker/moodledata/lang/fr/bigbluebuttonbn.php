...
/**
 * Strings for component 'bigbluebuttonbn', language 'fr', version '5.1'.
 *
...
$string['resetrecordings_help'] = 'La suppression des enregistrements les supprimera de ce cours. Le média enregistré sur le serveur BigBlueButton ne sera pas impacté !';
...
$string['view_recording_delete_confirmation'] = 'Voulez-vous vraiment supprimer définitivement {$a} ? Cette action supprimera le fichier média du serveur BigBlueButton et ne peut être annulée.';
