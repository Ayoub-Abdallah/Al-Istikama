...
/**
 * Strings for component 'moodle', language 'fr', version '5.1'.
 *
 * @package     moodle
 * @category    string
...
$string['gpl'] = 'Copyright (C) 1999 et années ultérieures, Ayoub Ben Chahla (https://moodle.com/)
...
$string['gpl3'] = 'Copyright (C) 1999 et années ultérieures, Ayoub Ben Chahla (https://moodle.com/)
...
$string['hiddensectionscollapsed'] = 'N’afficher que les noms des sections';
$string['hiddensectionscollapsed_description'] = 'Les noms des sections sont affichées aux étudiants, mais les contenus des sections sont cachés.';
$string['hiddensectionsinvisible'] = 'Cacher totalement';
$string['hiddensectionsinvisible_description'] = 'Les sections cachées ne sont pas affichées aux étudiants';
...
$string['maxnumberweeks'] = 'Nombre maximum de sections (obsolète)';
$string['maxnumberweeks_desc'] = 'La valeur maximum du nombre de sections apparaissant dans le menu déroulant (n’est valable que pour certains formats de cours). Ce réglage est obsolète et sera retiré dans une prochaine version de Moodle. Veuillez utiliser les réglages du format de cours en lieu et place.';
...
$string['noresultsfor_help'] = 'Veuillez vérifier l’orthographe ou essayer d’autres mots';
...
$string['privacy:metadata:shortlink'] = 'Détails de l’URL courte';
$string['privacy:metadata:shortlink:component'] = 'Le composant associé au lien court';
$string['privacy:metadata:shortlink:identifier'] = 'L’identifiant unique associé au lien court';
$string['privacy:metadata:shortlink:linktype'] = 'Le type de lien avec lequel le lien court peut être identifié';
$string['privacy:metadata:shortlink:shortcode'] = 'Le code à utiliser pour le lien court';
$string['privacy:metadata:shortlink:userid'] = 'L’ID de l’utilisateur associé au lien court';
