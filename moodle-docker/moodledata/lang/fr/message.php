...
/**
 * Strings for component 'message', language 'fr', version '5.1'.
 *
 * @package     message
 * @category    string
...
$string['cannotsendmessages'] = 'Impossible d’envoyer des messages';
...
$string['nopermissiontosend'] = 'Vous n’avez pas les permissions requises pour envoyer des messages dans cette conversation';
