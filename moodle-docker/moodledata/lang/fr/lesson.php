...
/**
 * Strings for component 'lesson', language 'fr', version '5.1'.
 *
 * @package     lesson
 * @category    string
...
$string['allowedattempts'] = 'Tentatives permises par étudiants';
...
$string['handlingofretakes'] = 'Méthode d’évaluation';
$string['handlingofretakes_help'] = 'La façon dont la note est calculée quand les étudiants ont la permission de effectuer la leçon plus d’une fois :

* La note la plus élevée de tous les essais
* La note moyenne de tous les essais';
...
$string['maximumnumberofattempts'] = 'Nombre maximal d’essais par question';
$string['maximumnumberofattempts_help'] = 'Le nombre de fois qu’un étudiant peut essayer de répondre à chaque question. Si cette limite est atteinte sans réponse correcte, la leçon se poursuit avec la page suivante.';
$string['maximumnumberofattemptsreached'] = 'Vous avez atteint le nombre maximal d’essais pour cette question. La leçon va maintenant passer à la page suivante.';
...
$string['retakesallowed'] = 'Permettre plusieurs tentatives';
$string['retakesallowed_help'] = 'Permettre aux étudiants d’effectuer la leçon plus d’une fois.';
$string['retakesallowedinfo'] = 'Cette leçon permet aux étudiants de l’effectuer à plusieurs reprises.';
...
$string['studentswhoattempted'] = 'Étudiants avec tentatives';
...
$string['totalattepmts'] = 'Total des tentatives';
...
$string['usemaximum'] = 'La note la plus élevée de tous les essais';
$string['usemean'] = 'La note moyenne de tous les essais';
...
$string['usersnone'] = 'Il n’y a pas d’utilisateur inscrit à ce cours ou aucun utilisateur ne peut accéder à la leçon.';
