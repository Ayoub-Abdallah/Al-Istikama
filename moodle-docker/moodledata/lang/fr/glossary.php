...
/**
 * Strings for component 'glossary', language 'fr', version '5.1'.
 *
 * @package     glossary
 * @category    string
...
$string['numberofentriesneedapprove'] = 'Requiert approbation';
...
$string['seeallentries'] = 'Voir tous les articles';
