...
/**
 * Strings for component 'h5pactivity', language 'fr', version '5.1'.
 *
 * @package     h5pactivity
 * @category    string
...
$string['attempted'] = 'Étudiants avec tentatives';
...
$string['averageattempts'] = 'Nombre moyen de tentatives par étudiant';
$string['choice'] = 'Choix';
...
$string['true'] = 'Vrai';
$string['unknowntype'] = 'Type H5P inconnu';
