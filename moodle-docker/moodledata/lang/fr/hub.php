...
/**
 * Strings for component 'hub', language 'fr', version '5.1'.
 *
 * @package     hub
 * @category    string
...
$string['organisationname'] = 'Nom de l’organisation';
$string['organisationname_help'] = 'Le nom de l’organisation est affiché dans la liste des sites si vous choisissez de l’afficher.';
...
$string['siteprivacylinked'] = 'Afficher le nom de mon organisation avec un lien';
$string['siteprivacynotpublished'] = 'Ne pas afficher mon site';
$string['siteprivacypublished'] = 'N’afficher que le nom de mon organisation';
