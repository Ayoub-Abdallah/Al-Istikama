...
/**
 * Strings for component 'admin', language 'fr', version '5.1'.
 *
 * @package     admin
 * @category    string
...
$string['composerdeveloperdependenciesinstalled'] = 'Les dépendances de Composer pour le développement sont installées. Assurez-vous que la commande « composer install --no-dev --classmap-authoritative » a été lancée dans le dossier racine de Moodle.';
$string['composernotfound'] = 'Les dépendances de Composer n’ont pas été trouvées. Assurez-vous que la commande « composer install --no-dev --classmap-authoritative » a été lancée dans le dossier racine de Moodle. Si vous n’utilisez pas Composer, assurez-vous que le dossier « vendor » existe et contient les fichiers nécessaires.';
$string['composernotoptimised'] = 'Moodle fonctionne en mode de production alors que le chargeur automatique de Composer n’est pas optimisé. Vous devriez lancer la commande « composer install --no-dev --classmap-authoritative » pour optimiser le chargeur automatique.';
$string['composeroptimisedindevmode'] = 'Moodle fonctionne en mode de développement alors que le chargeur automatique de Composer est optimisé. Ceci peut provoquer des problèmes dans certains cas. Vous devriez lancer la commande « composer install » sans argument supplémentaire.';
...
$string['courserequestnotifyemail'] = '<p>L’utilisateur {$a->user} a demandé un nouveau cours.</p>
<p>Vous pouvez examiner cette requête sur <a href="{$a->link}">Cours en attente d’approbation</a>.</p>

<p>Détails de la requête :</p>
<ul>
<li>Nom complet du cours : {$a->fullname}</li>
<li>Nom abrégé du cours : {$a->shortname}</li>
<li>Catégorie : {$a->category}</li>
<li>Raison de la requête du cours : {$a->reason}</li>
</ul>';
