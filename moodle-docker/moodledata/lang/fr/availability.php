...
/**
 * Strings for component 'availability', language 'fr', version '5.1'.
 *
...
$string['shown_all'] = 'Nom de l’élément affiché avec les informations de restriction d’accès si les conditions ne sont pas remplies par l’étudiant';
$string['shown_individual'] = 'Nom de l’élément affiché avec les informations de restriction d’accès si cette condition n’est pas remplie par l’étudiant';
