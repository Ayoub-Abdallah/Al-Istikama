...
/**
 * Strings for component 'customfield', language 'fr', version '5.1'.
 *
 * @package     customfield
 * @category    string
...
$string['eventsharedcategoryusagedisabled'] = 'Utilisation de catégorie partagée activée';
$string['eventsharedcategoryusageenabled'] = 'Utilisation de catégorie partagée désactivée';
...
$string['privacy:metadata:customfield_shared'] = 'Un champ personnalisé partagé enregistré dans un contexte.';
$string['privacy:metadata:customfield_shared:area'] = 'La zone avec laquelle le champ partagé est associée';
$string['privacy:metadata:customfield_shared:categoryid'] = 'L’ID de la catégorie à laquelle appartient le champ partagé';
$string['privacy:metadata:customfield_shared:component'] = 'Le composant avec lequel le champ partagé est associé';
$string['privacy:metadata:customfield_shared:itemid'] = 'L’ID de l’élément avec lequel le champ partagé est associé';
...
$string['sharedcategoryhelptext'] = 'Si ce réglage est activité, les champs personnalisés de cette catégorie seront utilisés';
$string['sharedcustomfields'] = 'Champs personnalisés partagés';
