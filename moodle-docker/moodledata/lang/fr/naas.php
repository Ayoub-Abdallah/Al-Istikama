...
/**
 * Strings for component 'naas', language 'fr', version '5.1'.
 *
 * @package     naas
 * @category    string
...
$string['grade_method'] = 'Méthode de notation';
...
$string['gradetopass'] = 'Note de passage';
...
$string['naas:addinstance'] = 'Ajouter un nouveau module NaaS';
...
$string['naas_settings_css'] = 'CSS NaaS';
...
$string['naas_settings_password'] = 'Mot de passe API NaaS';
$string['naas_settings_password_help'] = 'Entrez le mot de passe API NaaS';
...
$string['privacy:metadata:core_completion'] = 'Le plugin Nugget enregistre l’achèvement d’une activité Nugget.';
...
$string['privacy:metadata:naas'] = 'L’activité Nugget communique avec la plateforme NaaS pour récupérer le Nugget, suivre la réalisation du Nugget et renvoyer une note. Les traces d’apprentissage liées à l’exécution des Nuggets sont collectées de manière anonyme sur la plateforme NaaS. Lorsque la collecte du courriel de l’utilisateur est activée pour le plugin, ces traces seront associées au courriel, permettant de personnaliser l’expérience de l’utilisateur. Les données collectées sont stockées sur le serveur NaaS et ne sont pas partagées avec des tiers.';
...
$string['privacy:metadata:naas_xapi'] = 'L’activité Nugget transmet des traces d’apprentissage xAPI à la plateforme NaaS. Les données collectées sont stockées sur le serveur NaaS et ne sont pas partagées avec des tiers. L’administrateur peut permettre la collecte des noms et adresses de courriel pour personnaliser l’expérience des utilisateurs, ou au contraire rendre ces traces anonymes.';
$string['privacy:metadata:naas_xapi:body'] = 'Le contenu de la trace d’apprentissage xAPI.';
$string['privacy:metadata:naas_xapi:email'] = 'Le courriel de l’utilisateur. Ces informations peuvent être utilisées pour personnaliser l’expérience de l’utilisateur en associant ses différentes sessions sur différents Nuggets. L’administrateur peut désactiver la transmission de ces informations.';
...
$string['test_connection'] = 'Tester la connexion';
