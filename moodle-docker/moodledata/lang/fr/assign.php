...
/**
 * Strings for component 'assign', language 'fr', version '5.1'.
 *
 * @package     assign
 * @category    string
...
$string['assignmentduesoonofflinehtml'] = '<p>Bonjour {$a->firstname},</p>
<p>Le délai pour le devoir <strong>{$a->assignmentname}</strong> du cours {$a->coursename} arrive bientôt à échéance.</p>
<p>Si vous avez déjà remis votre travail, aucune action n’est requise de votre part.</p>
<p><strong>À rendre le : {$a->duedate}</strong></p>
<p><a href="{$a->url}">Vers l’activité</a></p>';
$string['assignmentduesoonsms'] = 'Votre devoir {$a->assignmentname} est à rendre le {$a->duedate} : {$a->shortlink}';
...
$string['assignmentoverduesms'] = 'Votre devoir {$a->assignmentname} pour le {$a->duedate} est en retard : {$a->shortlink}';
...
$string['resizelayout'] = 'Redimensionner la mise en page';
...
$string['usersnone'] = 'Il n’y a pas d’utilisateur inscrit à ce cours ou aucun utilisateur ne peut accéder au devoir.';
