...
/**
 * Strings for component 'repository_upload', language 'fr', version '5.1'.
 *
...
$string['upload_error_folders_not_supported'] = 'Compresser le dossier dans un fichier ZIP pour le déposer.';
$string['upload_error_folders_not_supported_title'] = 'Ce dossier ne peut pas être déposé';
