...
/**
 * Strings for component 'error', language 'fr', version '5.1'.
 *
 * @package     error
 * @category    string
...
$string['rootdirpublic'] = 'Le dossier racine de Moodle ne doit pas être accessible publiquement. Veuillez reconfigurer le serveur web afin qu’il utilise en lieu et place le dossier « /public ».';
...
$string['wwwrootpublic'] = '$CFG->wwwroot incorrect dans le fichier config.php. Il ne doit pas se terminer par /public.';
