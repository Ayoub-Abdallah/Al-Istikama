...
/**
 * Strings for component 'diary', language 'fr', version '5.1'.
 *
 * @package     diary
 * @category    string
...
$string['itemtypefiles'] = 'Fichiers';
$string['itemtypenone'] = 'Aucun';
$string['itemtypensentences'] = 'Phrases';
$string['itemtypeparagraphs'] = 'Paragraphes';
$string['itemtypewords'] = 'Mots';
