...
/**
 * Strings for component 'workshop', language 'fr', version '5.1'.
 *
 * @package     workshop
 * @category    string
...
$string['deadline'] = 'Date limite de la phase';
...
$string['overview_assessment_grade'] = 'Note pour lՎvaluation';
$string['overview_submission_grade'] = 'Note pour le travail remis';
