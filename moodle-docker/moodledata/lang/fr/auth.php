...
/**
 * Strings for component 'auth', language 'fr', version '5.1'.
 *
 * @package     auth
 * @category    string
...
$string['auth_forgotpasswordrecaptcha'] = 'Activer reCAPTCHA pour la récupération de mot de passe';
$string['auth_forgotpasswordrecaptcha_desc'] = 'Ajouter un élément de confirmation visuel/audio au formulaire de récupération de mot de passe. Ceci réduit le risque de tentatives de récupération de mot de passe indues. Pour plus d’informations, voir <a href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
