...
/**
 * Strings for component 'data', language 'fr', version '5.1'.
 *
 * @package     data
 * @category    string
...
$string['numberofentriestoapprove'] = 'Fiches à approuver : {$a}';
...
$string['totalentries'] = 'Nombres de fiches';
...
$string['viewentries'] = 'Consulter les fiches';
