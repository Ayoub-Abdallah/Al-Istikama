...
/**
 * Strings for component 'format_weeks', language 'fr', version '5.1'.
 *
...
$string['maxinitialsections'] = 'Nombre maximum initial de sections';
$string['maxinitialsections_help'] = 'Le nombre maximum de sections hebdomadaires pouvant être indiqué lors de la création d’un cours. Ce réglage n’empêche pas les enseignants d’ajouter ultérieurement plus de sections dans la page du cours.';
