...
/**
 * Strings for component 'report_coursemanager', language 'fr', version '5.1'.
 *
...
$string['total_filesize_threshold'] = 'Poids maximum d’un cours (Mo)';
...
$string['unique_filesize_threshold'] = 'Poids maximum d’un fichier (Mo)';
