...
/**
 * Strings for component 'board', language 'fr', version '5.1'.
 *
 * @package     board
 * @category    string
...
$string['acceptedfiletypeforgeneral'] = 'Types de fichiers acceptés pour les fichiers de contenu généraux.';
$string['acceptedfiletypeforgeneral_desc'] = 'Saisir la liste des extensions de fichiers autorisées pour les fichiers de contenu général séparés par des virgules, par exemple « txt, pdf, docx ».';
...
$string['aria_updatecolumn'] = 'Mettre à jour la colonne {column}';
...
$string['board:managetemplates'] = 'Gérer les modèles de tableau.';
...
$string['column_deleted_text'] = 'La colonne dans laquelle vous publiez a été supprimée.';
...
$string['error_notemplates'] = 'Aucun modèle trouvé.';
...
$string['form_general_file'] = 'Fichier';
...
$string['limited_markdown_checkbox'] = 'Afficher des exemples de formatage de contenu';
$string['limited_markdown_examples'] = '<pre>
# Ceci est un titre

Il s\'agit d\'un paragraphe standard couvrant plusieurs
lignes. Les paragraphes sont séparés par une ligne vide.

- élément de liste avec texte en *italique*
- élément de liste avec texte en **gras**
- élément de liste avec texte en ***gras et italique***

1. premier élément de liste numéroté
2. deuxième élément de liste numéroté
</pre>';
...
$string['settings'] = 'Paramètres du tableau';
...
$string['template'] = 'Modèle de tableau';
$string['template_apply'] = 'Appliquer le modèle';
$string['template_columns'] = 'Colonnes';
$string['template_create'] = 'Ajouter un modèle';
$string['template_delete'] = 'Supprimer le modèle';
$string['template_description'] = 'Description du modèle';
$string['template_export'] = 'Exporter le modèle';
$string['template_import'] = 'Importer le modèle';
$string['template_update'] = 'Mettre à jour le modèle';
$string['templates'] = 'Modèles de tableaux';
