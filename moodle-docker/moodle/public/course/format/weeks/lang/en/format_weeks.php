...
$string['maxinitialsections'] = 'Maximum initial number of sections';
$string['maxinitialsections_help'] = 'The maximum number of weekly sections that can be set when a course is created. This setting does not restrict teachers from adding more sections from the course page.';
