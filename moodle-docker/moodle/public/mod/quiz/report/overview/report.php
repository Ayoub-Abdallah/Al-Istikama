...
class quiz_overview_report extends attempts_report
{
    ...
    protected function display_commit_regrade_if_required(
        ...
        echo html_writer::div(
            get_string(
                'regrade_regradeneedednotificationmessage',
                'quiz_overview',
     ...
     */
    protected function process_regrade_actions(
        $quiz,
        $cm,
        $currentgroup,
        \core\dml\sql_join $groupstudentsjoins,
     ...
     * @param \core\dml\sql_join $groupstudentsjoins empty for all attempts, otherwise regrade attempts
     */
    protected function regrade_batch_of_attempts(
        $quiz,
        array $attempts,
        bool $dryrun,
        \core\dml\sql_join $groupstudentsjoins
     ...
     */
    protected function count_attempts_and_questions_needing_regrade(
        $quiz,
        \core\dml\sql_join $groupstudentsjoins
    ): array {
        global $DB;
