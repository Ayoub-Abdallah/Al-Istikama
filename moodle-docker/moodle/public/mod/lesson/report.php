...
if ($action === 'delete') {
    ...
    **************************************************************************/
    ...
    if ($data->lessonscored) {
        ...
        $stattable->head = array(
            get_string('averagescore', 'lesson'),
            get_string('averagetime', 'lesson'),
            get_string('highscore', 'lesson'),
            get_string('lowscore', 'lesson'),
            get_string('hightime', 'lesson'),
    ...
    foreach ($answerpages as $page) {
        ...
        if (!empty($page->answerdata) && !empty($page->answerdata->answers)) {
            ...
            if (isset($page->answerdata->response)) {
                $table->data[] = array(
                    $fontstart . get_string("response", "lesson") . ": <br />" . $fontend
