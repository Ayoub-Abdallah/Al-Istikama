...
final class locallib_test extends mod_lti_testcase
{
    ...
    public function test_split_custom_parameters(): void
    {
        ...
        $this->assertEquals(
            lti_split_custom_parameters(null, $tool, array(), "X=1", true),
        ...
        $this->assertEquals(
            lti_split_custom_parameters(null, $tool, array(), 'Review:Chapter=1.2.56', true),
            array(
        ...
        $this->setUser($user);
        $this->assertEquals(
            array('custom_x' => '1', 'custom_y' => 'SOMETHING'),
    ...
    public function disabled_test_sign_parameters()
    {
        $correct = array(
            ...
            'oauth_nonce' => '47458148e33a8f9dafb888c3684cf476',
            'oauth_signature' => 'qWgaBIezihCbeHgcwUy14tZcyDQ=',
            'oauth_signature_method' => 'HMAC-SHA1',
            'oauth_timestamp' => '1307141660',
            'oauth_version' => '1.0',
...
';
    ...
    public function test_lti_build_content_item_selection_request(): void
    {
        ...
        $result = lti_build_content_item_selection_request(
            $typeid,
            $course,
            $returnurl,
            $title,
...
-----END PUBLIC KEY-----';
    ...
    {
        $generator = $this->getDataGenerator()->get_plugin_generator('mod_lti');
        return $generator->create_instance(array(
            'course' => $course->id,
