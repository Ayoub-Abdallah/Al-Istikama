 ...
 *                 Ayoub Ben Chahla <http://dougiamas.com>
 ...
 * @package core_portfolio
 * @category portfolio
 * @copyright 2009 Penny Leach <penny@catalyst.net.nz>, Ayoub Ben Chahla
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
...
class portfolio_format_richhtml extends portfolio_format_rich
{
     ...
     */
    public static function conflicts($format)
    { // TODO revisit the conflict with file, since we zip here
