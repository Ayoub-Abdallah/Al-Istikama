 ...
 *
 * @package    core
 * @copyright  2013 onwards Ayoub Ben Chahla  http://dougiamas.com
...
class question_preview_cleanup_task extends scheduled_task
{
    ...
    public function execute()
    {
        ...
        $oldpreviews = new \qubaid_join(
            ...
            ',
            [
                'qubacomponent' => 'core_question_preview',
                'qubacomponent2' => 'core_question_preview',
