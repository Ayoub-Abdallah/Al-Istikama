...
class completion_info
{
    ...
    public function update_state(
        ...
        if (
            $possibleresult == $current->completionstate ||
        ...
        if (
            $cm->completion == COMPLETION_TRACKING_AUTOMATIC && !is_null($current->overrideby)
    ...
    public function internal_set_data($cm, $data, $isbulkupdate = false)
    {
        ...
        if ($data->userid == $USER->id) {
            ...
            if (
                !($cachedata = $completioncache->get($cachekey))
    ...
    public function get_completion_data(int $coursemoduleid, int $userid, array $defaultdata): array
    {
        ...
        $data = $DB->get_record_sql($sql, [
            'cmccoursemoduleid' => $coursemoduleid,
            'cmcuserid' => $userid,
            'cmvcoursemoduleid' => $coursemoduleid,
            'cmvuserid' => $userid
        ]);
