...
class qtype_numerical extends question_type
{
    ...
    public function save_question_options($question)
    {
        ...
        foreach ($question->answer as $key => $answerdata) {
            ...
            if (trim($question->tolerance[$key]) == '') {
                ...
                $options->tolerance = $this->apply_unit(
    ...
    public function save_units($question)
    {
        ...
        foreach ($question->multiplier as $i => $multiplier) {
            ...
            if (
                !empty($question->multiplier[$i]) && !empty($question->unit[$i]) &&
                ...
                $units[$i]->multiplier = $this->apply_unit(
    ...
    public function initialise_numerical_answers(question_definition $question, $questiondata)
    {
        ...
        foreach ($questiondata->options->answers as $a) {
            $question->answers[$a->id] = new qtype_numerical_answer(
                $a->id,
                $a->answer,
                $a->fraction,
                $a->feedback,
    ...
    public function get_possible_responses($questiondata)
    {
        ...
        foreach ($questiondata->options->answers as $aid => $answer) {
            ...
            if ($responseclass === '*') {
                ...
                $ans = new qtype_numerical_answer(
                    $answer->id,
                    $answer->answer,
                    $answer->fraction,
                    $answer->feedback,
