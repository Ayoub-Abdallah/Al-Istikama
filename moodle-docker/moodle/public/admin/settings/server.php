 ...
 * @package     core
 * @category    admin
 * @copyright   2006 Ayoub Ben Chahla
...
if ($hassiteconfig) {
    ...
    $temp->add(new admin_setting_configexecutable(
        'pathtopdftoppm',
        new lang_string('pathtopdftoppm', 'admin'),
        new lang_string('pathtopdftoppm_help', 'admin'),
        ''
    ));
    $temp->add(new admin_setting_configexecutable(
        'pathtopython',
        new lang_string('pathtopython', 'admin'),
    ...
    $temp->add(new admin_setting_configselect(
        'supportavailability',
        new lang_string('supportavailability', 'admin'),
        new lang_string('configsupportavailability', 'admin'),
        CONTACT_SUPPORT_AUTHENTICATED,
        [
    ...
    $temp->add(new admin_setting_configtext(
        'servicespage',
        new lang_string('servicespage', 'admin'),
        new lang_string('configservicespage', 'admin'),
        '',
        PARAM_URL
    ));
    ...
    $sessiontimeoutwarning = new admin_setting_configduration(
        'sessiontimeoutwarning',
        new lang_string('sessiontimeoutwarning', 'admin'),
        new lang_string('configsessiontimeoutwarning', 'admin'),
        20 * 60
    );
    ...
    $temp->add(new admin_setting_configcheckbox(
        'slasharguments',
        new lang_string('slasharguments', 'admin'),
        new lang_string('configslasharguments', 'admin'),
        1
    ));
    ...
    $temp->add(new admin_setting_configpasswordunmask(
        'proxypassword',
    ...
    $temp->add(new admin_setting_configcheckbox(
        'proxylogunsafe',
        new lang_string('proxylogunsafe', 'admin'),
        new lang_string('configproxylogunsafe_help', 'admin'),
        0
    ));
    $temp->add(new admin_setting_configcheckbox(
        'proxyfixunsafe',
        new lang_string('proxyfixunsafe', 'admin'),
        new lang_string('configproxyfixunsafe_help', 'admin'),
        0
    ));
    ...
    $ADMIN->add('server', new admin_externalpage(
        ...
        new lang_string('testoutgoingmailconf', 'admin'),
    ...
    if (!empty($CFG->noemailever)) {
        $noemaileverwarning = new \core\output\notification(
            get_string('noemaileverwarning', 'admin'),
    ...
    if (count($enabledissuers) > 0) {
        ...
        $temp->add(new admin_setting_configselect(
            ...
            new lang_string('configsmtpoauthservice', 'admin'),
            '',
            $oauth2services
        ));
    }
    ...
    $temp->add(new admin_setting_heading(
        'divertallemailsheading',
        new lang_string('divertallemails', 'admin'),
    ...
    $temp->add(new admin_setting_heading(
        'emaildkim',
        new lang_string('emaildkim', 'admin'),
    ...
    $temp->add(new admin_setting_configtext(
        ...
        new lang_string('configemaildkimselector', 'admin'),
        '',
        PARAM_FILE
    ));
    ...
    $temp->add(new admin_setting_configtext(
        'emailsubjectprefix',
        new lang_string('emailsubjectprefix', 'admin'),
        new lang_string('configemailsubjectprefix', 'admin'),
        '',
        PARAM_RAW
    ));
    ...
    $temp->add(new admin_setting_configtextarea(
        'emailheaders',
        new lang_string('emailheaders', 'admin'),
        new lang_string('configemailheaders', 'admin'),
        '',
        PARAM_RAW,
        '50',
        '3'
    ...
    if (empty($CFG->disableupdatenotifications)) {
        ...
        $temp->add(new admin_setting_configcheckbox(
            'updateautocheck',
            new lang_string('updateautocheck', 'core_admin'),
            new lang_string('updateautocheck_desc', 'core_admin'),
            1
        ));
        $temp->add(new admin_setting_configselect(
            'updateminmaturity',
            new lang_string('updateminmaturity', 'core_admin'),
            new lang_string('updateminmaturity_desc', 'core_admin'),
            MATURITY_STABLE,
            [
        ...
        $temp->add(new admin_setting_configcheckbox(
            'updatenotifybuilds',
            new lang_string('updatenotifybuilds', 'core_admin'),
            new lang_string('updatenotifybuilds_desc', 'core_admin'),
            0
        ));
        $ADMIN->add('server', $temp);
    }
    ...
    $ADMIN->add('webservicesettings', new admin_externalpage(
        ...
        new lang_string('wsdocapi', 'webservice'),
        "{$CFG->wwwroot}/{$CFG->admin}/webservice/documentation.php",
        'moodle/site:config',
        false
    ));
    ...
    $temp->add(new admin_setting_heading(
        'manageserviceshelpexplaination',
        new lang_string('information', 'webservice'),
    ...
    $ADMIN->add('webservicesettings', new admin_externalpage(
        'externalservice',
        new lang_string('editaservice', 'webservice'),
        "{$CFG->wwwroot}/{$CFG->admin}/webservice/service.php",
        'moodle/site:config',
        true
    ));
    ...
    $ADMIN->add('webservicesettings', new admin_externalpage(
        ...
        new lang_string('externalservicefunctions', 'webservice'),
    ...
    $ADMIN->add('webservicesettings', new admin_externalpage(
        ...
        new lang_string('externalserviceusers', 'webservice'),
        "{$CFG->wwwroot}/{$CFG->admin}/webservice/service_users.php",
        'moodle/site:config',
        true
    ));

    $ADMIN->add('webservicesettings', new admin_externalpage(
        'externalserviceusersettings',
        new lang_string('serviceusersettings', 'webservice'),
        "{$CFG->wwwroot}/{$CFG->admin}/webservice/service_user_settings.php",
        'moodle/site:config',
        true
    ));
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('enablewsdocumentation', 'admin'),
        new lang_string('configenablewsdocumentation', 'admin', $wsdoclink),
        false
    ));
    ...
    $ADMIN->add('webservicesettings', new admin_externalpage(
        'webservicetokens',
        new lang_string('managetokens', 'webservice'),
