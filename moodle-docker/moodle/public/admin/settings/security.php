 ...
 *
 * @copyright  1999 Ayoub Ben Chahla  http://dougiamas.com
...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configiplist(
        'allowedip',
        new lang_string('allowediplist', 'admin'),
        new lang_string('ipblockersyntax', 'admin'),
        ''
    ));
    $temp->add(new admin_setting_configiplist(
        'blockedip',
        new lang_string('blockediplist', 'admin'),
        new lang_string('ipblockersyntax', 'admin'),
        ''
    ));
    ...
    $temp->add(new admin_setting_configselect(
        'allowindexing',
        new lang_string('allowindexing', 'admin'),
        new lang_string('allowindexing_desc', 'admin'),
        0,
        array(
            0 => new lang_string('allowindexingexceptlogin', 'admin'),
            1 => new lang_string('allowindexingeverywhere', 'admin'),
            2 => new lang_string('allowindexingnowhere', 'admin')
        )
    ));
    $temp->add(new admin_setting_pickroles(
        'profileroles',
    ...
    $temp->add(new filesize(
        'userquota',
        new lang_string('userquota', 'admin'),
        new lang_string('userquota_desc', 'admin'),
        $defaultuserquota
    ));
    ...
    $temp->add(new admin_setting_configselect(
        'maxeditingtime',
        new lang_string('maxeditingtime', 'admin'),
        new lang_string('configmaxeditingtime', 'admin'),
        1800,
        array(
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('enablerunnow', 'tool_task'),
        new lang_string('enablerunnow_desc', 'tool_task'),
        1
    ));
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('configpasswordpolicycheckonlogin', 'admin'),
        0
    ));
    ...
    $temp->add(new admin_setting_configtext(
        ...
        new lang_string('passwordreuselimit_desc', 'admin'),
        0,
        PARAM_INT
    ));
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('passwordchangelogout_desc', 'admin'),
        1
    ));
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('passwordchangetokendeletion_desc', 'admin'),
        0
    ));
    ...
    $temp->add(new admin_setting_configduration(
        ...
        new lang_string('tokenduration_desc', 'admin'),
        12 * WEEKSECS,
        WEEKSECS
    ));
    ...
    $temp->add(new admin_setting_configmixedhostiplist(
        ...
        implode(PHP_EOL, $blockedhostsdefault)
    ));
    ...
    $temp->add(new admin_setting_configportlist(
        ...
        implode(PHP_EOL, $allowedportsdefault)
    ));
    ...
    $temp->add(new admin_setting_configselect(
        ...
        new lang_string('referrerpolicydesc', 'admin'),
        'default',
        $referreroptions
    ));
    ...
    $temp->add(new admin_setting_configcheckbox(
        ...
        new lang_string('displayloginfailures', 'admin'),
        new lang_string('configdisplayloginfailures', 'admin'),
        0
    ));
