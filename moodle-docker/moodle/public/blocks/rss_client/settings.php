...
if ($ADMIN->fulltree) {
    $settings->add(new admin_setting_configtext(
        ...
        get_string('numentries', 'block_rss_client'),
        get_string('clientnumentries', 'block_rss_client'),
        5,
        PARAM_INT
    ));
    ...
    $settings->add(new admin_setting_configtext(
        ...
        get_string('timeout2', 'block_rss_client'),
        get_string('timeout', 'block_rss_client'),
        30,
        PARAM_INT
    ));
