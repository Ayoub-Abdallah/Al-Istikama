...
} else if ($returnto === 'istikama') {
    // Istikama admin: return to our custom Users management page after save/cancel.
    $returnurl = new moodle_url('/local/istikama_admin/users.php');
} else if ($user->id === -1) {
